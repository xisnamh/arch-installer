			...
			while true; do
				...
				case $manual_opt in
					1)
						...
						printf "${ico_line}${silver} Dispositivos${end}\n"
						...
						printf "${ico_line}${silver} Escaneo y Estaciones${end}\n"
						...
						printf "${ico_line}${silver} Gestion de Redes Conocidas${end}\n"
						printf "  known-networks list                             - Listar guardadas\n"
						printf "  known-networks <SSID> forget                    - Borrar guardada\n\n"
						printf "${ico_line}${silver} Modos Especiales${end}\n"
